        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link to="/admin/Dashboard" className="nav-link active text-white" aria-current="page">
                Dashboard
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              {/* Link to "My Evaluations" page */}
              <Link className="nav-link text-white" to="/admin/addCourse">
                Add courses
              </Link>
            </li>
            <li className="nav-item">
              {/* Link to "My Evaluations" page */}
              <Link className="nav-link text-white" to="/admin/manageCourse">
                Available courses
              </Link>
            </li>
            <li className="nav-item">
              {/* Link to "My Evaluations" page */}
              <Link className="nav-link text-white" to="/admin/Evaluations">
                Add Evaluation
              </Link>
            </li>
            <li className="nav-item">
              {/* Link to "My Evaluations" page */}
              <Link className="nav-link text-white" to="/admin/EvRecord">
                Evaluation record
              </Link>
            </li>
